...
ADD_ROLE_ACTION("Pointman", "Direct Combat", "Medium_Kits");
ADD_ROLE_ACTION("Pointman", "Direct Combat", "Heavy_Kits");
ADD_ROLE_ACTION("Pointman", "Direct Combat", "Light_Kits");
...
ADD_ROLE_ACTION("Rocket Grenadier", "Fire Support", "Light_Kits");
ADD_ROLE_ACTION("Rocket Grenadier", "Fire Support", "Medium_Kits");
ADD_ROLE_ACTION("Rocket Grenadier", "Fire Support", "Heavy_Kits");
