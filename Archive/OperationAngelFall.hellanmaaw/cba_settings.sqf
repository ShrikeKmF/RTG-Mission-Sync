...
force force FFPP_main_SET_tellVictim = true;
...
// SRV Storm
force SRV_STORM_FlagOptionsString = "";
...
vtx_uh60_anvishud_defaultMode = 3;
...
vtx_uh60_sfmPlus_showDamageHints = false;
vtx_uh60_sfmPlusStabilatorEnabled = 0;
