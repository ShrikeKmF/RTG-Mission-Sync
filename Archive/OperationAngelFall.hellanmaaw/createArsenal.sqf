...
#define SUPPORT_GL_LOADOUT \
	LOADOUT_MAG("1Rnd_Smoke_Grenade_shell", 12, 1) \
	LOADOUT_MAG("ACE_HuntIR_M203", 3, 1)
...
if (_role == "CMD") then
{
	...
	_gear = [["JCA_arifle_M4A4_GL_black_F","acwp_rc1","ACE_DBAL_A3_Green","acwp_eotech",["rtg_30rnd_556_45",30],[],""],[],["ptv_p320t","","","",["ptv_15Rnd_9mm_P320",15],[],""],["rtg_g3_mc",[BASIC_Medical []]],["rtg_Crye_AVS_2",[BASIC_Vest SUPPORT_GL_LOADOUT ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",6,30]]],["rtg_radiopack_black",[BASIC_Pack ["ACE_bodyBag",1],["Laserbatteries",1,1]]],"VSM_OPS_multicam","rhsusf_shemagh2_gogg_tan",["rtg_laserDesignator_tan_gh","","","",["Laserbatteries",1],[],""],["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_brown_gh"]];
};
...
if (_role == "AT") then
{
	...
	_arsenalEquipment append _submachineguns;
	_arsenalEquipment append _battlerifles;
	_gear = [["JCA_arifle_M4A4_VFG_black_F","acwp_rc1","ACE_DBAL_A3_Green","acwp_eotech",["rtg_30rnd_556_45",30],[],""],["rtg_MRAWS_olive","","","",["rtg_MRAWS_HEAT_F",1],[],""],["ptv_p320t","","","",["ptv_15Rnd_9mm_P320",15],[],""],["rtg_g3_mc",[BASIC_Medical []]],["rtg_Crye_AVS_2",[BASIC_Vest ["rtg_30rnd_556_45",6,30]]],["rtg_VSM_Multicam_Backpack_Kitbag",[BASIC_Pack ["rtg_MRAWS_HEAT_F",2,1],["rtg_MRAWS_HE_F",2,1],["rtg_MRAWS_SMK_F",3,1]]],"VSM_OPS_multicam","rhsusf_shemagh2_gogg_tan",["Binocular","","","",[],[],""],["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_brown_gh"]];
};
if (_role == "MG") then
{
...
if (_role == "PM") then
{
	...
	_arsenalEquipment append _submachineguns;
	_arsenalEquipment append _battlerifles;
	_gear = [["RTG_M4A1_9_GL_Black_F","muzzle_snds_L","","acwp_eotech",["rtg_9mm_35Rnd_mag",35],[],""],[],["acwp_glock17_black","","","",["ACWP_19Rnd_9x21_Mag_glock",19],[],""],["rtg_g3_mc",[BASIC_Medical []]],["rtg_Crye_AVS_2",[BASIC_Vest ["rtg_9mm_35Rnd_mag",6,35],["ACWP_19Rnd_9x21_Mag_glock",4,19]]],["rtg_VSM_Multicam_Backpack_Compact",[BASIC_Pack ["ACE_DefusalKit",1],["ACE_M26_Clacker",1],["MineDetector",1],["ToolKit",1],["rhsusf_m112_mag",6,1],["SatchelCharge_Remote_Mag",1,1]]],"VSM_OPS_multicam","rhsusf_shemagh2_gogg_tan",["Binocular","","","","",[],""],["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_brown_gh"]];
};
if (_role == "RFL") then
{
	_arsenalEquipment append _glAmmo;
