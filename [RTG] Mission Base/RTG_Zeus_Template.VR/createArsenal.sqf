...
_gear = [
		...
		["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
...
switch (_role) do {
	...
	case "Team Leader": {
		...
		_gear = [
			...
			["rtg_radiopack_black",[["Laserbatteries",1,1],["ptv_1Rnd_HEDP_Grenade_shell",10,1],["1Rnd_SmokeRed_Grenade_Shell",5,1],["1Rnd_Smoke_Grenade_shell",10,1],["ACE_HandFlare_Green",4,1],["B_IR_Grenade",2,1]]],
			"rtg_ech_od","",
	...
	case "Medic": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_radiopack_black",[["ACE_bloodIV_500",8],["ACE_bloodIV",4],["KAT_Empty_bloodIV_500", 4],["ACE_plasmaIV_500",4],["kat_Pulseoximeter",10],["kat_AED",1],["kat_accuvac",1],["ACE_tourniquet",8],["ACE_epinephrine",18],["kat_fentanyl",8],["kat_atropine",10],["kat_naloxone",10],["ACE_elasticBandage",34],["ACE_quikclot",34],["ACE_packingBandage",34],["ACE_surgicalKit",1],["kat_BVM",1],["kat_larynx",10],["ACE_morphine",16],["kat_chestSeal",8],["ACE_splint",5]]],
			"rtg_ech_od","",
			["Binocular","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Rifleman": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_200rnd_556_45",5,200]]],
			"rtg_ech_od","",
			["rtg_laserDesignator_tan_gh","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Pointman": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_200rnd_556_45",5,200],["MineDetector",1],["ACE_wirecutter",1],["ACE_DefusalKit",1]]],
			"rtg_ech_od","",
			["rtg_laserDesignator_tan_gh","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Automatic Rifleman": {
		...
		_gear = [
			...
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_200rnd_556_45_t",5,200]]],
			"rtg_ech_od","",
			["Binocular","","","",[],[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_brown_gh"]
		];
	...
	case "Grenadier": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor02_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["Laserbatteries",1,1],["ptv_1Rnd_HEDP_Grenade_shell",20,1],["1Rnd_SmokeRed_Grenade_shell",5,1],["1Rnd_Smoke_Grenade_shell",15,1],["twc_2inch_he_1rnd",10,1],["twc_2inch_smoke_1rnd",15,1]]],
			"rtg_ech_od","",
	...
	case "Rocket Grenadier": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_rpg_hedp_mag",6, 1], ["rtg_rpg_smk_mag",4, 1]]],
			"rtg_ech_od","",
			["Binocular","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Combat Engineer": {
		_arsenalEquipment append _LightLaunchers;
		_arsenalEquipment append _eng;
		_arsenalEquipment append _demo;
		...
		_gear = [
			...
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["ACE_Clacker",1],["MineDetector",1],["ACE_wirecutter",1],["ACE_DefusalKit",1],["tsp_breach_stick_mag",8,1],["rhsusf_m112_mag",4,1],["SLAMDirectionalMine_Wire_Mag",3,1],["tsp_breach_package_mag",2,1]]]
			,"rtg_ech_od","",
			["Binocular","","","",[],[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Medium Anti-Tank": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_MRAWS_HEAT_F",2, 1], ["rtg_MRAWS_HE_F",2, 1], ["rtg_MRAWS_SMK_F",2, 1]]],
			"rtg_ech_od","",
			["Binocular","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
	...
	case "Machine Gunner": {
		...
		_gear = [
			...
			["ptv_p320t","","","",["ptv_15Rnd_9mm_P320",15],[],""],
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["rtg_200Rnd_762x51_t",6,100]]],
			"rtg_ech_od","",
			["Binocular","","","",[],[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_brown_gh"]
		];
	...
	case "Heavy Anti-Tank": {
		...
		_gear = [
			...
			["rtg_shirtcut_black_black",[BASIC_UNIFORM []]],
			["V_thor_r_rgr",[BASIC_Vest ["ptv_15Rnd_9mm_P320",3,15],["rtg_30rnd_556_45",7,30]]],
			["rtg_VSM_OGA_OD_Backpack_Kitbag",[["Titan_AT",2, 1]]],
			"rtg_ech_od","",
			["Binocular","","","","",[],""],
			["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ItemWatch","rtg_pvs_15_green_gh"]
		];
