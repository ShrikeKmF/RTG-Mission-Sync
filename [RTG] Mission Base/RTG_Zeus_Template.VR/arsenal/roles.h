...
roleData = [
    ...
    ["Specialist", [
        ...
        ["Machine Gunner",   ["Medium_Kits", "Heavy_Kits"], "The Machine Gunners role is to support the section through the use of a medium Machine gun to suppress the enemy elements, to achieve fire superiority."],
