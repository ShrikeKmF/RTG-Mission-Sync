...
roleData = [
    ...
    ["Direct Combat", [
        ...
        ["Pointman",    ["Light_Kits", "Medium_Kits", "Heavy_Kits"], "The Pointman is tasked with detecting mines and ensuring the sections safe movement and to assist the more specialist roles by carrying additional ammo"]
    ]],
    ...
    ["Weapons Squad", [
        ["Medium Anti-Tank", [],"The Medium Anti-Tanks role is to take heavy enemy assets out from a medium to short range."],
        ["Machine Gunner",   [], "The Machine Gunners role is to support the section through the use of a medium Machine gun to suppress the enemy elements, to achieve fire superiority."],
        ["Ammo Bearer",  [], "The Ammo Bearer's role is to support the Weapons Squad by carring the tripod and extra ammo"],
        ["CSW Gunner",  [], "The CSW Gunners role is to operate the Crew Served Weapons to provide heavy fire support to the infantry units."]
    ]]
];
...
roleDataWeapons = [
    ["Command and Support", [
        ...
        ["Medic",       [], "The Medic’s role is to keep the section alive and patch up the injured."],
        ["Crewman",     [], "The Crewman's role is to operate many RTG vehicles to support the infantry sections whether that be by driving Armored vehicles."],
        ["Pilot",       [], "The Pilot operates all of RTG air craft inclduing both Fixed and Rotary Wing"]
    ]],
    
    ["Direct Combat", [
        ["Rifleman",    [], "The Rifleman is the junior member of the section whose role is to provide an adaptable and flexible capability to the section to assist the more specialist roles by carrying additional ammo and LATs."],
        ["Light Rifleman", [], "The Rifleman is the junior member of the section whose role is to provide an adaptable and flexible capability to the section to assist the more specialist roles by carrying additional ammo and LATs/SAMs."],
        ["Pointman",    [], "The Pointman is tasked with detecting mines and ensuring the sections safe movement and to assist the more specialist roles by carrying additional ammo"]
    ]],
    ...
    ["Fire Support", [
        ...
        ["Grenadier",          [], "The Grenadiers job it to rain hell with long range explosive whether that be with there grenade launcher or there 60mm mortar"],
        ["Rocket Grenadier",   [], "The Rocket Grenadier's role is to support the section through direct fire HE rockets."],
    ...
    ["Weapons Squad", [
        ["Medium Anti-Tank", ["Medium_Kits"],"The Medium Anti-Tanks role is to take heavy enemy assets out from a medium to short range."],
        ...
        ["Ammo Bearer",  ["Light_Kits", "Medium_Kits"], "The Ammo Bearer's role is to support the Weapons Squad by carring the tripod and extra ammo"],
        ["CSW Gunner",  ["Light_Kits", "Medium_Kits"], "The CSW Gunners role is to operate the Crew Served Weapons to provide heavy fire support to the infantry units."]
    ]]
];
